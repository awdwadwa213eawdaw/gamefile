...
local roundedFrame = require(storage:WaitForChild("Plugins").RoundedFrame){Utilities=Utilities}
...
Group = Utilities.class({}, function(self)
	...
	self.gui = c
	--	if self.inviteOnly then
	--		self:updateIcon(335296862)--183809700)
	--	end
	self:updateMembers()
...
function Group:destroy()
	...
	self.overflowThread = nil
	self.members = nil
	pcall(function() self.joinButton:destroy() end)
	pcall(function() self.gui:destroy() end)
	-- TODO: destroy cached display names?
end
