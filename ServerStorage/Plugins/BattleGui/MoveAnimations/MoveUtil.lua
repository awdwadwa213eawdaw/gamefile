...
function v1.blast(p57, p58, p59, p60, p61, p62, p63, p64, p65)
	...
	v1.Tween(TweenInfo.new(p65 or 0.5, Enum.EasingStyle.Cubic), true, function(p66)
...
function v1.NewTransition(p130)
	...
	--v135.ScreenInsets = Enum.ScreenInsets.None
	--v135.SafeAreaCompatibility = Enum.SafeAreaCompatibility.None
