--[[
Original Module by Stravant
Modified by tbradm:
 Fixed reading/writing float 0.5 (original module wrote 0.0)
 Added WriteCFrame / ReadCFrame
 Added static SetBit / GetBit (for writing / reading a bit to / from a Base64 string without creating a buffer)
...
Read/Write pairs for reading data from or writing data to the BitBuffer:
	...
	BitBuffer:ReadRotation()
		...
		a single axis. For other rotations, the results may not be
