return function(_p)
	...
	local function getExtendedPokemonIcon(t)
		...
		if t[4] then
			local img2 = _p.Pokemon:getIcon(t[4], t[2])
			img2.SizeConstraint = Enum.SizeConstraint.RelativeYY
			img2.Size = UDim2.new(0.75, 0, 0.6, 0)
			img2.AnchorPoint = Vector2.new(0.5, 0.5)
			img2.Position = UDim2.new(0.2, 0, 0.725, 0)
			img2.ZIndex = 6
			img2.Parent = icon
		elseif t[5] then
			local img2 = _p.Menu.bag:getItemIcon(t[5])
			img2.SizeConstraint = Enum.SizeConstraint.RelativeYY
			img2.Size = UDim2.new(.5, 0, .5, 0)
			img2.AnchorPoint = Vector2.new(0.5, 0.5)
			img2.Position = UDim2.new(0.15, 0, 0.85, 0)
			img2.ZIndex = 6
			img2.Parent = icon
		end
		...
		local function addIcon(c)
			create 'ImageLabel' {
				Name = 'CircleIconBG',
				Image = 'rbxassetid://6789172149',
				ImageColor3 = Color3.fromRGB(27, 42, 53),
				BackgroundTransparency = 1.0,
				Size = UDim2.new(0.0, -22, 0.0, -22),
				Position = UDim2.new(0.97, 0, y, 0),
				ZIndex = 6,
				Parent = icon,
				create 'ImageLabel' {
					Name = 'CircleIcon',
		...
		if t[2] then
			addIcon(BrickColor.new('Persimmon').Color)
		end

		if t[6] then
			addIcon(BrickColor.new('Mint').Color)
		end
		...
		if t[3] then
			create 'ImageLabel' {
				Name = "Lock",
				BackgroundTransparency = 1.0,
				Image = 'rbxassetid://78108741131999',
				Size = UDim2.new(0.25, 0, 0.325, 0),
				Position = UDim2.new(0, 0, 0, 0),
				ZIndex = 6, Parent = icon
			}
		end
	...
	function TradeGui:animateTrade(myOfferIcons, theirOfferIcons, evolutions)
		...
		pokemonContainer1:Destroy()
		pokemonContainer2:Destroy()
		Utilities.Tween(0.3, "easeOutCubic", function(a)
