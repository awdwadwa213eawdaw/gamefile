return function(_p)
	...
	function shop:buySelection()
		...
		if _p.NPCChat:Say('You must save before purchasing.', '[y/n]Would you like to save the game?') then
	...
	function shop:onLoadChunk(chunk)
		...
		interact[chunk.npcs.TicketSeller.model] = function()
			if chat:say(chunk.npcs.TicketSeller, "Want lots of Tix, but don't have time?", "I'll give you 5,000 of my Tix for 174 of your R$.", "[y/n]Does that sound like a fair deal?") then
